...
LLVA.Login.LoginWindow = Ext.extend(Ext.Window,
    ...
    (function() {
        ...
        return {
                        ...
                        loginForm = new Ext.form.FormPanel({
                            ...
                            items: [                    
                                ...
                                new Ext.form.ComboBox({ 
                                    ...
                                    listeners:{
                                        "select": function() {
                                            Ext.getCmp("station").setValue(Ext.getCmp('facilityNo').value);
                                        }            
                                    }           
                                }),
                            ...
                            buttons: [
                                new Ext.Button({
                                    ...
                                    width: 150,
                                    handler: function() { 
                                        Ext.util.Cookies.set("gov.lom.med.defaultFacilityNo", Ext.getCmp('facilityNo').value, nextYear());
                                        Ext.util.Cookies.set("gov.lom.med.defaultFacilityStr",Ext.getCmp('facilityNo').getRawValue(), nextYear());
                                        doLogin();
                                    }                                   
                                }) 
                            ]
            ...
            listeners: {
                show: function() { 
                   if (Ext.getCmp('facilityNo').getValue() === "") {
                       Ext.getCmp('facilityNo').focus(false, 100);
                   } else {
