...
public class DateUtils {
  ...
  public static void main(String[] args) throws ParseException {
    ...
    String s = "Thu Oct 03 07:52:31 MDT 2013";
    String mm = StringUtils.piece(s, ' ', 2);
    String dd = StringUtils.piece(s, ' ', 3);
    String tt = StringUtils.piece(s, ' ', 4);
    String hh = StringUtils.piece(tt, ':', 1);
    String min = StringUtils.piece(tt, ':', 2);
    String yy = StringUtils.piece(s, ' ', 6);
    ...
    calendar.setTime(dt);
    double d = dateTimeToFMDateTime(calendar);
