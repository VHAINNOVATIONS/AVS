...
import gov.va.med.lom.javaUtils.file.*;
...
public class StringUtils {
  ...
  public static String wrapLine(String str, int wrapLength) {
    return wrapLine(str, wrapLength, ' ', null, false);
  }
  ...
  public static void main(String[] args) {
    String s = "10165246^605^8/2/13@13:30^602^15852~~96375~~96372~96366~82948~99401^P:585.6~~~~~~~^PN:1194735514~~~^~~~^^^^MT COPAY REQUIRED~REGULAR~NSC^1^0";
    StringUtils.setPiece(s, '^', 5, "A^B^C^D");
