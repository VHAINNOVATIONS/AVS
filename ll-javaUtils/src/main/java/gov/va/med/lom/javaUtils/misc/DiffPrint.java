...
public class DiffPrint {
  ...
  public static abstract class Base {
    ...
    public void printHeader(String filea, String fileb) {
      setupOutput();
    }
  ...
  public static class NormalPrint extends Base {
    ...
    protected void printHunk (Diff.change hunk) {
      ...
      printNumberRange (',', first0, last0);
      outfile.print(changeLetter(inserts, deletes));
      printNumberRange (',', first1, last1);
      outfile.println();
  ...
  public static class EdPrint extends Base {
    ...
    protected void printHunk(Diff.change hunk) {
      ...
      /* Print out the line number header for this hunk */
      printNumberRange (',', first0, last0);
      outfile.println(changeLetter(inserts, deletes));
  ...
  public static class ContextPrint extends Base {
    ...
    protected void printContextLabel (String mark, File inf, String label) {
      setupOutput();
      if (label != null)
    ...
    public void printHeader(String filea,String fileb) {
      printContextLabel ("***", new File(filea), filea);
      printContextLabel ("---", new File(fileb), fileb);
    }
    ...
    protected void printFunction(Object[] file,int start) {
  ...
  public static void main(String[] argv) throws IOException {
    ...
    String[] a = loadFile(filea);
    String[] b = loadFile(fileb);
    Diff d = new Diff(a,b);
    char style = 'n';
    ...
    Diff.change script = d.diff(reverse);
    if (script == null)
