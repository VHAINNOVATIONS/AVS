Ext.define('LLVA.AVS.Wizard.view.IFrame', {
    ...
    initEvents : function() {
        var me = this,
            ...
            frameEl = me.getFrame();
        me.setContentEditable(false);
        me.callParent();
        me.iframeEl.on('load', me.onLoad, me);
    },

    setContentEditable : function(editable) {
        this.getDoc().designMode = editable ? 'On' : 'Off';
        this.getDoc().contentEditable = editable;
    },    
