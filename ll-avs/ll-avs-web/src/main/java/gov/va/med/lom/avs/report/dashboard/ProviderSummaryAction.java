...
public class ProviderSummaryAction extends BaseDashboardReportsAction implements ServletRequestAware, Preparable {

private static final Log log = LogFactory.getLog(ProviderSummaryAction.class);
