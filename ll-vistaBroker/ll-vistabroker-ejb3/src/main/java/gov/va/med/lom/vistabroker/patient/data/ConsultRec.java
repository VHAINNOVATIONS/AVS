...
public class ConsultRec implements Serializable {
  
  private String ien;
  private Date entryDate;
  private String entryDateStr;
  private int orFileNumber;
  private String patientLocationIen;
  private String orderingFacilityIen;
  private int foreignConsultFileNum;
  ...
  public int getForeignConsultFileNum() {
    return foreignConsultFileNum;
  }

  public void setForeignConsultFileNum(int foreignConsultingFileNum) {
  ...
  public int getOrFileNumber() {
    return orFileNumber;
  }
  
  public void setOrFileNumber(int orFileNumber) {
