  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (vistaSignonResult.getSignonSucceeded()) {
        ...
        Object[] params = {"SYS", ""}; 
        String x = rpcBroker.call("ORQQPX LVREMLST", params);
        List<String> list = StringUtils.getStringList(x);
        for (String s : list) {
