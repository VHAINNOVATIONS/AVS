...
public class ExampleDevicesRpc {
  ...
  public static void main(String[] args) {
    ...
    String verify = null;
    if (args.length != 1) {
      System.out.println("Usage: java ExampleDevicesRpc AUTH_PROPS");
    ...
    try {
      ...
      if (vistaSignonResult.getSignonSucceeded()) {
        ...
        // Create a devices rpc object
        DevicesRpc devicesRpc = new DevicesRpc(rpcBroker);
        Device[] devices = devicesRpc.subsetOfDevices("2~", 1);
        for(int i = 0; i < devices.length; i++) {
          System.out.println(devices[i].getDisplayName() + " (IEN: " + devices[i].getIen() + "): " + devices[i].getLocation());
        }
      } else {
