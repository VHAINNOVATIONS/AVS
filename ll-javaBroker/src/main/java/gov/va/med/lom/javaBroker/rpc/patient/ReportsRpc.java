...
public class ReportsRpc extends AbstractRpc {
  ...
  // CONSTRUCTORS
  public ReportsRpc() throws BrokerException {
    super();
  }
  
  public ReportsRpc(RpcBroker rpcBroker) throws BrokerException {
    super(rpcBroker);
  }
  
  // RPC API
  public synchronized String getReportsText(String dfn, Date fromDate, Date toDate, int nrpts, String arg) throws BrokerException {
    if (setContext("OR CPRS GUI CHART")) {
      ...
      Object[] params = {dfn, arg, "", "", "", String.valueOf(fromDateFM), String.valueOf(toDateFM)}; 
      return rpcBroker.call("ORWRP REPORT TEXT", params);
    } else
